AFRAME.registerComponent("info-banner", {
  ...
  createBanner: function () {
    postersInfo = {
      "iron-man": {
        banner_url: "./Card/iron-man-comic.png",
        title: "IRON MAN",
        released_year: "2009",
        description:
      ...
      "spider-man": {
        banner_url: "./Card/spider-man-comic.png",
        title: "SPIDER MAN",
        released_year: "1963",
        description:
      ...
      "black-widow": {
        banner_url: "./Card/black-widow-comic.png",
        title: "BLACK WIDOW",
        released_year: "2020",
        description:
      ...
      loki: {
        banner_url: "./Card/loki-comic.png",
        title: "LOKI",
        released_year: "1952",
        description:
    ...
    entityEl.setAttribute("id", `${itemId}-comic`);
